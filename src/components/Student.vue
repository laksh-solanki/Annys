...
<template>
    ...
    <v-container>
        <v-card class="pa-5 card-animation w-100" border="1" elevation="2" rounded="3">
            <v-card-title class="text-h5 text-center text-wrap bg-dark text-white rounded-3">Student Registration
                Form</v-card-title>
            <v-card-text>
                <v-form @submit.prevent="submitForm">
                    <v-row>
                        ...
                        <v-col cols="12" md="6">
                            <v-text-field v-model="form.fname" label="Full Name" variant="outlined" name="fname"
                                id="fname" rounded="2" aria-required="true"></v-text-field>
                        </v-col>
                        <v-col cols="12" md="6">
                    ...
                    <v-row class="mt-3">
                        ...
                        <v-col cols="12" md="6">
                            <v-text-field v-model="form.prnNo" label="PRN No." variant="outlined" name="prnNo"
                                id="prnNo" rounded="2"></v-text-field>
                        </v-col>
                        <v-col cols="12" md="6">
                    ...
                    <v-row class="mt-5 justify-content-start">
                        ...
                        <v-col cols="12" md="3" class="d-flex justify-center justify-content-lg-start">
                            <v-tooltip text="Preview and Download the certificate" location="top">
                                <template v-slot:activator="{ props }">
                                    <v-btn v-bind="props" @click="generatePdf" color="primary"
                                        text="Preview Certificate"></v-btn>
                                </template>
                            </v-tooltip>
                        </v-col>
                    </v-row>
